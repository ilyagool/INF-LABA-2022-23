...
string surnames[10] = { "Ivan","Alexey","Alex","Dmitry","Maksim","Artem","Grisha","Anton","Anatoly","Petr" };
string names[10] = { "Ivanov","Pantsirev","Penyov","Kozlov","Gribovsky","Mikheev","Plekheev","Lodkin","Shchelkov","Utkin" };
string patronymic[10] = { "Aleksandrovich","Alexeyevich","Владимирович","Olegovych","Denisovich","Sergeevich","Anatolevich","Ivanovich","Danilovich","Yurievich" };
